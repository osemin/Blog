...
$kontrol = mysql_num_rows(mysql_query("SELECT * FROM makale where alt_id='1' and makale_id='".$_GET['makale_id']."'"));
 if ($kontrol==0) {?>
 

<div class="row">
    <div class="col-1"><h1>Her hangi bir makale seçmediniz!</h1></div>
</div>

 <?} else { ?>
 	<?php

$veri=mysql_query("SELECT * FROM makale where makale_id='".$_GET['makale_id']."'");
$mal=mysql_fetch_assoc($veri);
...
<div class="col-md-8">
						...
						<div class="section-row">
							<div class="post-author">
									...
									<?php 
								$mak=mysql_query("select * from yorumlar where makale_id='".$_GET['makale_id']."'   
											");
                                   while ($son=mysql_fetch_array($mak)) {?>
								<div class="media">
									...
									<div class="media-body">
										<div class="media-heading">
											<h3><?php echo $son['isim']; ?></h3>
										</div>
										<p> <?php echo $son['yorum'];?></p>
							...
							<div class="section-title">
								<h2>Yorum Yap</h2>
								<p>Lütfen yıldız ile gösterilen zorunlu alanları doldurunuz*</p>
							</div>
							 <form role="form" method="post" action="islem.php" enctype="multipart/formdata" >
            	 			 <input type="hidden" name="yorumekle" value="true">
   							 <input type="hidden" class="form-control" name="makale_id" 
  							  value="<?php echo $_GET['makale_id']; ?>">
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<span>İsim(Nick) *</span>
							<input class="input" type="isim" name="isim" id="isim" required="">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
									...
									<div class="col-md-12">
										<div class="form-group">
						<textarea class="input" name="yorum" <textarea  cols="30" rows="10" class="form-control" name="yorum" id="yorum" placeholder="Mesaj" required=""></textarea>
										</div>
						<a href="postblog.php?makale_id&makale_id=<?=$son['makale_id'];?>">
